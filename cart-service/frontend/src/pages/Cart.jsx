...
`http://127.0.0.1:8003/api/cart/${userId}/`
);
...
cart.items.forEach(async (item) => {
  ...
  try {
    const res = await axios.get(
      `http://127.0.0.1:8002/api/products/${item.product_id}/`
    );
...
try {
await axios.delete(
`http://127.0.0.1:8003/api/cart/${userId}/item/${itemId}/remove/`
);
...
try {
  await axios.put(
    `http://127.0.0.1:8003/api/cart/${userId}/item/${itemId}/`,
    {
      quantity: quantity,
    }
  );
